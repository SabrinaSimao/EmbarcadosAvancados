...
# ----------------------------------------
# ACDS 18.0 614 linux 2018.09.28.12:13:53
...
if ![info exists QUARTUS_INSTALL_DIR] { 
  set QUARTUS_INSTALL_DIR "/home/sabrina/intelFPGA_lite/18.0/quartus/"
}
...
alias file_copy {
  ...
  file copy -force $QSYS_SIMDIR/submodules/niosHello_program_memory.hex ./
  file copy -force $QSYS_SIMDIR/submodules/niosHello_onchip_memory2_0.hex ./
}
...
ensure_lib                                              ./libraries/program_memory/                              
vmap       program_memory                               ./libraries/program_memory/                              
...
ensure_lib                                              ./libraries/keypad_0/                                    
vmap       keypad_0                                     ./libraries/keypad_0/                                    
...
alias com {
  ...
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/niosHello_mm_interconnect_0_cmd_mux_002.sv"                       -work cmd_mux_002                                 
  ...
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/niosHello_mm_interconnect_0_router_004.sv"                        -work router_004                                  
  ...
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS        "$QSYS_SIMDIR/submodules/niosHello_program_memory.vhd"                                     -work program_memory                              
  ...
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS        "$QSYS_SIMDIR/submodules/keypad.vhd"                                                       -work keypad_0                                    
